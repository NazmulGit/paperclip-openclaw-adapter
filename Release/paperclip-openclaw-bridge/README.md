...
> **Renamed in v2.0.0.** Was `opencalw_adapter_for_paperclip` (typo + ambiguous "adapter" word) through v1.1.0. Plugin id changed from `paperclipai.plugin-openclaw-bridge` to `openclaw-bridge` — uninstall v1.x before installing v2.x.
